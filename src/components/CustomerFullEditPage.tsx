...
import { X, Loader2, FileText, ShieldCheck, Calendar, Save, Cpu, Droplets } from 'lucide-react';
...
export default function CustomerFullEditPage({ customerId, onClose, onSaved }: Props) {
  ...
  async function handleSaveAll() {
    ...
    const customerRow = toCustomerUpdate(form, isAr);
      ...
      <div className="bg-slate-50 w-full sm:max-w-3xl sm:rounded-2xl sm:max-h-[92vh] h-full sm:h-auto overflow-y-auto shadow-2xl">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-5 py-4 flex items-center justify-between z-10">
          <div>
            ...
            <p className="text-xs text-slate-500">{customerDisplayName(form) || customerName}</p>
          </div>
          ...
          <div className="p-5 space-y-6 pb-28">
            ...
            <section>
              ...
              <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-4 space-y-4">
                <CustomerFields form={form} errors={errors} onChange={patch} />
